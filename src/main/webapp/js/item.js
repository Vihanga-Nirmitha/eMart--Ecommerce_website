...
const bar1 = document.querySelector('#bar1 .col-bar');
const bar2 = document.querySelector('#bar2 .col-bar');
const bar3 = document.querySelector('#bar3 .col-bar');
const bar4 = document.querySelector('#bar4 .col-bar');
const bar5 = document.querySelector('#bar5 .col-bar');
